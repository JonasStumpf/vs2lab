...
class Coordinator:
    """
    Implements a 3 phase commit coordinator.
    ...
    def run(self):
        if False:  # simulate a crash in INIT state
        ...
        if False:  # simulate a crash in WAIT state
        ...
        # simulate possible crash
        if True:  # simulate a crash in PRECOMMIT state
